        ...
        for filename in files:
            if not filename.lower().endswith(".mp4"):
                ...
                if not os.path.exists(dest_file):
                    ...
                    print(
                        f"Skipped (already exists): {os.path.join(rel_path, filename)}"
                    )
...
if __name__ == "__main__":
    ...
    root_folder = r"D:\Projects\acsm\exmilton_gordon"  # Replace with your root folder containing multiple subfolders
    output_base_folder = r"D:\Projects\acsm\exmilton_gordon_scripts"  # Replace with your desired output base folder
